...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
        ...
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,                         KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,
                                                KY_SUPER_LALT,  LOWER,   KC_SPC,   KC_ENT,   RAISE,   KC_ALGR
    ),
  ...
  [_LOWER] = LAYOUT(
        ...
        _______,  KC_KP_0,    KC_PSCR,   KC_SLCK,  KC_PAUS,   KC_APP,                       KC_BSLS,  KC_MINS,  KC_EQL,   KC_LBRC,  KC_RBRC,  _______,
  ...
  [_RAISE] = LAYOUT(
        ...
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,                        KC_LEFT,  KC_DOWN,  KC_UP,    KC_RGHT,  KC_F11,   KC_GRV,
